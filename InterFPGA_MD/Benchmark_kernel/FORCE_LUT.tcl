...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {/home/chunshu/Documents/InterFPGA_MD/Benchmark_kernel/src/mem_init/c0_8.coe} \
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {/home/chunshu/Documents/InterFPGA_MD/Benchmark_kernel/src/mem_init/c0_14.coe} \
   CONFIG.Collision_Warnings {NONE} \
   CONFIG.Disable_Collision_Warnings {true} \
   CONFIG.Disable_Out_of_Range_Warnings {true} \
   CONFIG.EN_SAFETY_CKT {false} \
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {/home/chunshu/Documents/InterFPGA_MD/Benchmark_kernel/src/mem_init/c1_8.coe} \
   CONFIG.Collision_Warnings {NONE} \
   CONFIG.Disable_Collision_Warnings {true} \
   CONFIG.Disable_Out_of_Range_Warnings {true} \
   CONFIG.EN_SAFETY_CKT {false} \
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {/home/chunshu/Documents/InterFPGA_MD/Benchmark_kernel/src/mem_init/c1_14.coe} \
   CONFIG.Collision_Warnings {NONE} \
   CONFIG.Disable_Collision_Warnings {true} \
   CONFIG.Disable_Out_of_Range_Warnings {true} \
   CONFIG.EN_SAFETY_CKT {false} \
