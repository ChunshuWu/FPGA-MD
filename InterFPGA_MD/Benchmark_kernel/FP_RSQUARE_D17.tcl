...
################################################################
# This is a generated script based on design: FP_RSQUARE_D17
#
...
# source FP_RSQUARE_D17_script.tcl
...
set design_name FP_RSQUARE_D17
...
proc create_root_design { parentCell } {
  ...
  set d36_nb_reg_release_sel [ create_bd_port -dir O -from 5 -to 0 -type data d36_nb_reg_release_sel ]
  ...
  set nb_reg_release_sel [ create_bd_port -dir I -from 5 -to 0 -type data nb_reg_release_sel ]
  ...
  # Create instance: nb_reg_sel_d37, and set properties
  set nb_reg_sel_d37 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 nb_reg_sel_d37 ]
  set_property -dict [ list \
   CONFIG.Depth {36} \
   CONFIG.Width {6} \
 ] $nb_reg_sel_d37
  ...
  connect_bd_net -net D_0_4 [get_bd_ports nb_reg_sel] [get_bd_pins nb_reg_sel_d37/D]
  connect_bd_net -net D_1_1 [get_bd_ports home_parid] [get_bd_pins home_parid_d36/D]
  connect_bd_net -net D_1_2 [get_bd_ports nb_reg_release_sel] [get_bd_pins nb_reg_release_sel_d36/D]
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins dx/aclk] [get_bd_pins dx2/aclk] [get_bd_pins dx2_dy2/aclk] [get_bd_pins dx_d28/CLK] [get_bd_pins dy/aclk] [get_bd_pins dy_d24/CLK] [get_bd_pins dy_d4/CLK] [get_bd_pins dz/aclk] [get_bd_pins dz_d19/CLK] [get_bd_pins dz_d9/CLK] [get_bd_pins elements_d25/CLK] [get_bd_pins home_parid_d36/CLK] [get_bd_pins nb_cid_d36/CLK] [get_bd_pins nb_parid_d36/CLK] [get_bd_pins nb_reg_release_sel_d36/CLK] [get_bd_pins nb_reg_sel_d37/CLK] [get_bd_pins r2/aclk]
  ...
  connect_bd_net -net nb_reg_release_sel_d36_Q [get_bd_ports d36_nb_reg_release_sel] [get_bd_pins nb_reg_release_sel_d36/Q]
  connect_bd_net -net nb_reg_sel_d37_Q [get_bd_ports d36_nb_reg_sel] [get_bd_pins nb_reg_sel_d37/Q]
