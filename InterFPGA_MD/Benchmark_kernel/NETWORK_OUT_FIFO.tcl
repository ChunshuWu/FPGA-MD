...
################################################################
# This is a generated script based on design: NETWORK_OUT_FIFO
#
...
# source NETWORK_OUT_FIFO_script.tcl
...
set design_name NETWORK_OUT_FIFO
...
proc create_root_design { parentCell } {
  ...
  set din_0 [ create_bd_port -dir I -from 592 -to 0 din_0 ]
  set dout_0 [ create_bd_port -dir O -from 592 -to 0 dout_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Input_Data_Width {593} \
   CONFIG.Input_Depth {4096} \
   CONFIG.Output_Data_Width {593} \
