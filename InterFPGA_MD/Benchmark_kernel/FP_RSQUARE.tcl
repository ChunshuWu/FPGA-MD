...
proc create_root_design { parentCell } {
  ...
  set d36_node_id [ create_bd_port -dir O -from 2 -to 0 -type data d36_node_id ]
  ...
  set node_id [ create_bd_port -dir I -from 2 -to 0 -type data node_id ]
  ...
  # Create instance: node_id_d36, and set properties
  set node_id_d36 [ create_bd_cell -type ip -vlnv xilinx.com:ip:c_shift_ram:12.0 node_id_d36 ]
  set_property -dict [ list \
   CONFIG.Depth {36} \
   CONFIG.Width {3} \
 ] $node_id_d36
  ...
  connect_bd_net -net D_0_5 [get_bd_ports node_id] [get_bd_pins node_id_d36/D]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins dx/aclk] [get_bd_pins dx2/aclk] [get_bd_pins dx2_dy2/aclk] [get_bd_pins dx_d28/CLK] [get_bd_pins dy/aclk] [get_bd_pins dy_d24/CLK] [get_bd_pins dy_d4/CLK] [get_bd_pins dz/aclk] [get_bd_pins dz_d19/CLK] [get_bd_pins dz_d9/CLK] [get_bd_pins elements_d25/CLK] [get_bd_pins home_parid_d36/CLK] [get_bd_pins nb_cid_d36/CLK] [get_bd_pins nb_parid_d36/CLK] [get_bd_pins nb_reg_release_sel_d36/CLK] [get_bd_pins nb_reg_sel_d36/CLK] [get_bd_pins node_id_d36/CLK] [get_bd_pins r2/aclk]
  ...
  connect_bd_net -net node_id_d36_Q [get_bd_ports d36_node_id] [get_bd_pins node_id_d36/Q]
