...
################################################################
# This is a generated script based on design: FIFO_86W512D
#
...
# source FIFO_86W512D_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set din [ create_bd_port -dir I -from 88 -to 0 din ]
  set dout [ create_bd_port -dir O -from 88 -to 0 dout ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Full_Threshold_Assert_Value {514} \
   CONFIG.Full_Threshold_Negate_Value {513} \
   CONFIG.Input_Data_Width {89} \
   CONFIG.Input_Depth {1024} \
   CONFIG.Output_Data_Width {89} \
  ...
  connect_bd_net -net srst_0_1 [get_bd_ports srst] [get_bd_pins fifo_generator_0/srst]
